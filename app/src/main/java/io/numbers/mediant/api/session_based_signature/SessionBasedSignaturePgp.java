...
public class SessionBasedSignaturePgp {

    private static final String PROVIDER = "SC";
//    private static final String KEY_RING_ID = "asdf@asdf.com";

    private SessionBasedSignaturePgp mInstance;
    ...
    public final String DEFAULT_PASSWORD = "password"; //static string for local keystore
    ...
    public SessionBasedSignaturePgp ()
    {

    }

    public synchronized SessionBasedSignaturePgp getInstance (Context context)
    {
        return getInstance(context, DEFAULT_PASSWORD);
    }

    public synchronized SessionBasedSignaturePgp getInstance (Context context, String password)
    {
        mInstance = new SessionBasedSignaturePgp();
    ...
    public final static String genPGPPrivKey (PGPKeyRingGenerator krgen) throws IOException {
            // String pgpPublicKey = SessionBasedSignaturePgp.genPGPPublicKey(krgen);
    ...
    public synchronized void initCrypto (Context context, String password)
    {
        try {
            ...
            {
                // Re-use the existing public and private keyrings
